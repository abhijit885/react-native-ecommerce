  ...
  return (
    <>
        ...
        screenOptions={{
          ...
          headerLeft: () => (
            <Icon.Button name="ios-menu" size={25}
              backgroundColor="#00a799" color="#ffffff" onPress={() => navigation.openDrawer()}></Icon.Button>
          ),
          headerRight: () => (
            <Icon.Button name="ios-cart" size={25}
              backgroundColor="#00a799" color="#ffffff" onPress={() => navigation.navigate('ProsidToPlaceOrder')}>
      ...
      >
        ...
        <Shop.Screen name="CastomerShipingAddress" component={CastomerShipingAddress} />
        <Shop.Screen name="SelectPaymentMethod" component={SelectPaymentMethod} />
        ...
        <Shop.Screen name="perticulerCatagoryProduct" component={perticulerCatagoryProduct} />
        <Shop.Screen name="perticulerCatagoryIndivijualProduct" component={perticulerCatagoryIndivijualProduct} />
...
function SHOPBYCATAGORY({ navigation }) {
  return (
    <Shop.Navigator initialRouteName="catagoryDetails"
      screenOptions={{
        headerStyle: {
          backgroundColor: '#00a799',
        },
...
function PROFILE({ navigation }) {
  return (
    <Shop.Navigator initialRouteName="BookmarkScreen"
      screenOptions={{
        headerStyle: {
          backgroundColor: '#00a799',
        },
        ...
        <NavigationContainer theme={theme}>
          {loginState.userToken !== null ? (
            <Drawer.Navigator drawerContent={props => <DrawerContent {...props} />}>
              ...
              <Drawer.Screen name="Shop by catagory" component={SHOPBYCATAGORY} />
